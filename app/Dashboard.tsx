...
const defaultLinkSettings: Record<string, LinkSettings> = Object.fromEntries([...links, ...aiLinks].map((link) => [link.id, { url: link.url, name: link.name, key: "key" in link ? String(link.key) : "AI" }]));
